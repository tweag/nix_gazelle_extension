{ pkgs, nixpkgs ? pkgs.path, runJdk ? pkgs.openjdk16
...
in buildBazelPackage {
  ...
  bazelFetchFlags = [ "--loading_phase_threads=HOST_CPUS" ];
  bazelFlags = [
    "-c opt"
  ...
  fetchAttrs = {
    ...
    sha256 = if stdenv.hostPlatform.isDarwin then
      "0iwcv6lpkipibg4jpvf9y51ba0ns74q6k0vxav29pvyjybim9pjp"
    else
      "0fhp3sibv9drw8wghpklslfliws59r9wc41if78i90a3iy20afqs";
  };
