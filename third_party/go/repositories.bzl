...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:+HgusrAN9PVv0DeG0FZ2LZa+JeKKYJ3u7gkKUlzQNj8=",
    ...
    go_repository(
        name = "com_github_lainio_err2",
        importpath = "github.com/lainio/err2",
        sum = "h1:KwxYboDyKzqzwH3KMYcl6SjhQNPIhUB2vKEb2YVkyxA=",
        version = "v0.8.6",
    )
