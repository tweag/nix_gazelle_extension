...
// FIXME: export rule instance should not carry information
// meant for workspace target(s) i.e. nixpkgs_package
func (pkg *nixPackage) ToRule() *rule.Rule {
	...
	ruleStatement.SetAttr("repositories", pkg.repositories)
